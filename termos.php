<strong>Termos e condições de uso do site ou blog</strong> <br> <br>
Seja bem-vindo ao nosso site.. <br> <br> 
Este documento, e todo o conteúdo do site é oferecido por CRUD com o endereço http://localhost/site-termos/,  resguardando todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo.
A permanência no website implica-se automaticamente na leitura e aceitação tácita dos presentes termos de uso a seguir. Este termo foi atualizado pela última vez em 14 de setembro de 2021. <br> <br>

<strong>1. DA FUNÇÃO DO SITE</strong> <br> <br>
...
Nesta plataforma, poderá ser realizado tanto a divulgação de material original de alta qualidade, assim como a divulgação de produtos de e-commerce. <br>
...
É de responsabilidade do usuário de usar todas as informações presentes no site com senso crítico, utilizando apenas como fonte de informação, e sempre buscando especialistas da área para a solução concreta do seu conflito. <br> <br>

<strong>2. DO ACEITE DOS TERMOS</strong> <br> <br>
...
<strong>3. DO ACESSO AO SITE</strong> <br> <br>
...
Todos os dados estão protegidos conforme a Lei Geral de Proteção de Dados, e ao realizar o cadastro junto ao site, o VISITANTE concorda integralmente com a coleta de dados conforme a Lei e com a Política de Privacidade da EMPRESA. <br> <br> 

<strong>4. DA LICENÇA DE USO E CÓPIA</strong> <br> <br> 
...
A EMPRESA poderá em casos concretos permitir pontualmente exceções a este direito, que serão claramente destacados no mesmo, com a forma e permissão de uso do conteúdo protegido. Este direito é revogável e limitado as especificações de cada caso. <br> <br>

<strong>5. DAS OBRIGAÇÕES</strong> <br> <br>
...
•	Com a Política de Privacidade do site, assim como tratamos os dados referentes ao cadastro e visita no site, podendo a qualquer momento e forma, requerer a exclusão dos mesmos, através do formulário de contato. <br> <br>

<strong>6. DOS TERMOS GERAIS</strong> <br> <br>
...
Este Termo de uso é valido a partir de 18 de setembro de 2021.
